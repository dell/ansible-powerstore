...
class TestPowerStoreFileDNS(PowerStoreUnitBase):
    ...
    def test_create_file_dns_with_only_add_ip_addresses_response(self, powerstore_module_mock):
        self.set_module_params(
            powerstore_module_mock,
            self.get_module_args,
            {
    ...
    def test_create_file_dns_without_add_ip_addresses_response(self, powerstore_module_mock):
        self.set_module_params(
            powerstore_module_mock,
            self.get_module_args,
            {
        ...
        self.capture_fail_json_call(
            MockFileDNSApi.get_file_dns_exception_response(
                'create_without_ip_exception'), powerstore_module_mock, FileDNSHandler)
    ...
    def test_modify_file_dns_only_remove_ip_addresses(self, powerstore_module_mock):
        self.set_module_params(
            powerstore_module_mock,
            self.get_module_args,
            {
    ...
    def test_modify_file_dns_only_add_ip_addresses(self, powerstore_module_mock):
        self.set_module_params(
            powerstore_module_mock,
            self.get_module_args,
            {
