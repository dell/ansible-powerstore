...
class MockSnapshotApi:
    ...
    SECURE_VG_SNAP_DETAILS = {
        ...
        "volumes": [
            {
                "id": "5e8ad0c0-7b55-42fd-aa38-01524d42764a",
                "name": "secure_vg_snap.ansible_vg_vol"
            }
        ]
    }

    SECURE_VOL_SNAPS = [
        {'id': '83314020-31b7-4e2d-98d4-535a733f35e8', 'name': 'secure_vol_snap'}
    ]

    SECURE_VG_SNAPS = [
        {'id': 'f3baa2c7-bdef-4b83-8f71-b67c904683ab', 'name': 'secure_vg_snap'}
    ]
