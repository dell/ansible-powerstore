...
options:
  ...
  expiration_timestamp:
    ...
    - To remove the expiration timestamp, specify it as empty string.
    type: str
  access_type:
    description:
...
filesystem_snap_details:
    ...
    contains:
        ...
        expiration_timestamp:
            description:
                - The date and time the snapshot is due to be automatically
...
class PowerStoreFilesystemSnapshot(object):
    ...
    def delete_filesystem_snapshot(self, snapshot):
        ...
        try:
            ...
            e_msg = str(e)
            if isinstance(e, PowerStoreException):
