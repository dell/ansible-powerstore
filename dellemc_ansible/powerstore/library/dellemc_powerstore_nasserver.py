...
description:
- Supports the provisioning operations on a NAS Server
    Get the details of nas server
    Modify the attributes of a nas server
...
options:
 ...
 nas_server_new_name:
   description:
   - New name of the nas server for rename operation
   type: str
 current_node:
   description:
...
nasserver_details:
    ...
    contains:
        ...
        description:
            description:
                - description about the nas server.
            type: str
        operational_status:
            description:
        ...
        current_node:
            description:
                - Unique identifier and name of the node on which the NAS
                  server is running.
            type: dict
        preferred_node:
            description:
                - Unique identifier and name of the preferred node for
                  the NAS server.
            type: dict
        default_unix_user:
            description:
                - Default Unix user name used for granting access in case
                  of Windows to Unix user mapping failure.
            type: str
        current_unix_directory_service:
            description:
                - Define the Unix directory service used for looking up
                  identity information for Unix such as UIDs, GIDs, net
                  groups, and so on.
            type: str
        is_username_translation_enabled:
            description:
                - Enable the possibility to match a windows account to a
        ...
        file_interfaces:
            description:
                - This is the inverse of the resource type file_interface
                  association.Will return the id,name & ip_address of the
                  associated file interface
            type: dict
        nfs_servers:
            description:
                - This is the inverse of the resource type nfs_server
                  association..
            type: str
        smb_servers:
            description:
                - This is the inverse of the resource type smb_server
                  association.
            type: str
        file_ldaps:
            description:
                - This is the inverse of the resource type file_ldap
                  association..
            type: str
        file_systems:
            description:
