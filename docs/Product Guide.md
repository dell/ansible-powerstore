...
### Synopsis
 ...
 Configuration module includes cluster nodes, network, roles, local users, appliances, security configs, certificates, AD/LDAP servers, LDAP accounts, LDAP domain.
    ...
    <tr>
        ...
        <th width="100%">Description</th>
            ...
            <td> Whether or not the resource has changed. </td>
                    ...
                    <tr>
            <td colspan=2 > ldap_account_details </td>
            <td>  complex </td>
            <td> When LDAP account exists. </td>
            <td> Details of the LDAP account. </td>
        </tr>
                            <tr>
                <td class="elbow-placeholder">&nbsp;</td>
                <td colspan=1 > dn </td>
...
<table>
    <tr>
        ...
        <th width="80%">Description</th>
            ...
            <td></td>
            <td></td>
            <td> <br> User settings of LDAP domain. </td>
        </tr>
                            <tr>
                <td class="elbow-placeholder">&nbsp;</td>
                <td colspan=1 > user_id_attribute </td>
            ...
            <td></td>
            <td></td>
            <td> <br> Group settings of LDAP domain. </td>
        </tr>
                            <tr>
                <td class="elbow-placeholder">&nbsp;</td>
                <td colspan=1 > group_name_attribute </td>
...
<table>
    <tr>
        ...
        <th width="100%">Description</th>
            ...
            <td> Details of the LDAP domain configuration. </td>
        </tr>
                            <tr>
                <td class="elbow-placeholder">&nbsp;</td>
                <td colspan=1 > bind_user </td>
