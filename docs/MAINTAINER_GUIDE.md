...
* Lead by example
* Follow the [Code of Conduct](https://github.com/dell/ansible-powerstore/blob/3.2.0/docs/CODE_OF_CONDUCT.md) and the guidelines in the [Contributing](https://github.com/dell/ansible-powerstore/blob/3.2.0/docs/CONTRIBUTING.md) and [Committer](https://github.com/dell/ansible-powerstore/blob/3.2.0/docs/COMMITTER_GUIDE.md) guides
